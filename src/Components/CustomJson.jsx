        ...
        <div style={{paddingLeft:"120px", paddingRight:"120px", paddingBottom:"20px"}}>
            ...
            <div style={{display:"flex", justifyContent:"space-around"}}>
                <div style={{display:"flex", flexDirection:"column", textAlign:"center"}}>
                    ...
                    <div style={listToShow.includes("Brand") ? {display:"block"} : {display : "none"}}> <p>Input Brand</p> <input type="text" value={showBrand} onChange={brandHandler} style={{borderRadius:"20px", height:"30px", width:"240px", textAlign:"center"}}/> </div>
                    <div style={listToShow.includes("Price") ? {display:"block"} : {display : "none"}}> <p>Input Price</p> <input type="text" value={showPrice} onChange={priceHandler} style={{borderRadius:"20px", height:"30px", width:"240px", textAlign:"center"}}/> </div>
                    <div style={listToShow.includes("Image") ? {display:"block"} : {display : "none"}}> <p>Input Image</p> <input type="text" value={showImage} onChange={imageHandler} style={{borderRadius:"20px", height:"30px", width:"240px", textAlign:"center"}}/> </div>
                    <div style={listToShow.includes("Author") ? {display:"block"} : {display : "none"}}> <p>Input Author</p> <input type="text" value={showAuthor} onChange={authorHandler} style={{borderRadius:"20px", height:"30px", width:"240px", textAlign:"center"}}/> </div>
                    <div style={listToShow.includes("Rating") ? {display:"block"} : {display : "none"}}> <p>Input Rating</p> <input type="text" value={showRating} onChange={ratingHandler} style={{borderRadius:"20px", height:"30px", width:"240px", textAlign:"center"}}/> </div>
